...
$getRest = $operation->retrieveSingle("SELECT * FROM `restaurant_info` WHERE restaurant_id='$rest'");

//restaurant_image
	$image  ='';
	if($getRest['img_url'] != ''){
		$image =$getRest['img_url'];
	}else{
                  ...
                  <div class="card-body py-0">
					<div class="basic-info">
						<h4>Restaurant Information</h4>						
							<div class="driver-dt">								
								<a href="javascript:void(0);" onclick="setRestaurant('<?=$rest?>')"><img src="images/<?=$image?>" alt=""></a>
								<h4> <?=$getRest['restaurant_name']?></h4>
                              
							</div>
                      
						<div class="form-group">
                          <p class="">
                            <?=$getRest['restaurant_name']?> - <?=$getRest['exact_location']?> - 
                            0<?=$getRest['restaurant_phone']?>
                          </p>
...
-->
                                  <tr>
                                      ...
                                      <td>MWK <?=number_format($getProduct['product_price'],2)?></td>
                                      <td></td>
                                  </tr>
								 <tr>
                                      <th style="font-weight: 600;">Deliver Fee</th>
                                      <td>MWK <?=number_format($getProduct['delivery_fee'],2)?></td>
                                      <td></td>
                                  </tr>
								<tr>
