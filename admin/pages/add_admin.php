...
if($admin_level == 2){
  //get cities
    ...
    $access_level = '<option value="1">City Admin</option><option value="2">Super Admin</option>';
}else{
  //identify admin city
  //get city
  ...
  $selectCity = '<option value="'.$getCities['city_id'].'">'.$getCities['city_name'].'</option>';
    $access_level = '<option value="1">City Admin</option>';
}
...
<div id="content">
 <div class="card p-5">
   <div class="col-12">
    ...
    <form id="addAdminForm"  action="" enctype="multipart/form-data" method="post">
        <div class="row">
        ...
        <div class="col-12 col-sm-6">
          ...
          <div class="col-12 col-sm-6 mt-3">
            <div class="form-group">
                <button id="btn_save_restaurant" onclick="addAdmin()" class="btn btn-sm btn-warning text-light" type="submit"><i class="fas fa-save"></i> Save</button>
            </div>
          </div>
         </div>
