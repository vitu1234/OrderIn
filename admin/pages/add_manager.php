  ...
  $getRest = $operation->retrieveMany("SELECT * FROM `restaurant_info` ");
    foreach($getRest as $rest){
      $cit = $rest['city_id'];
        ...
        $selectRest .= '<option value="'.$rest['restaurant_id'].'">'.$rest['restaurant_name'].'-'.$getCity['city_name'].'</option>';
    }
}else{
  //identify admin city
  //get city
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6">
            <div class="form-group">
              ...
              <input type="text" maxlength="12" onkeypress="return isNumberKey(event)" class="form-control" data-bv-field="fullName" id="phone" name="phone" autocomplete="off" required placeholder="Phone" />
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6">
            <div class="form-group">
              ...
              <select class="form-control" name="rest_name" id="rest_name" required>
          ...
          <div class="col-12 col-sm-6 mt-3">
            <div class="form-group">
                <button id="btn_save_restaurant" onclick="addManager()" class="btn btn-sm btn-warning text-light" type="submit"><i class="fas fa-save"></i> Save</button>
            </div>
          </div>
         </div>
