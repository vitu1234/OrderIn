...
$operation = new Functions();
    ...
    if(isset($_POST['last_product_id'])){
     ...
     $sql = '';   
		...
		INNER JOIN restaurant_info ON restaurant_info.restaurant_id = products.restaurant_id WHERE products.restaurant_id = '$rest_id' AND product_id < ".$product." AND products.availability = 1 ORDER BY product_id DESC LIMIT 16";
