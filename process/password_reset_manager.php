...
// print_r($_POST);die();
 if(isset($_POST['reset_email']) && !empty($_POST['reset_email'])){
    ...
    //check the code sent
     ...
     //check email
     $getEmail = $operation->retrieveSingle("SELECT * FROM `password_reset` WHERE email = '$email' AND role='customer' ORDER BY id DESC");
     ...
     $where = "email = '$email' AND user_role ='customer'";
