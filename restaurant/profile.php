...
$getRestaurantId = $operation->retrieveSingle("SELECT * FROM `restaurant_managers` WHERE user_id = '$user_id'");
$rest_id = $getRestaurantId['restaurant_id'];
$getRestaurantName = $operation->retrieveSingle("SELECT * FROM `restaurant_info` WHERE restaurant_id = '$rest_id'");
						...
						<div class="container">							
							...
							<div class="profile-all-dt">
								<div class="profile-name-dt">
									...
									<p><span><i class="fas fa-map-marker-alt"></i></span> <?=$getRestaurantName['restaurant_name']." - ".$getCity['city_name']?></p>
								</div>								
							</div>
						</div>
					</div>
