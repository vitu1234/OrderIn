...
<head>
    ...
    <title>Natto | Restaurant Partner Dashboard</title>
							...
							<div class="col-md-8">
								<div class="topbar-right text-center text-md-right">
									<ul class="list-inline">
										...
										<li><a href="#bookmarks"><i class="far fa-bookmark"></i>Bookmarks <span class="badge badge-secondary">2</span></a></li>										
						...
						<div class="container">							
							...
							<div class="profile-all-dt">
								...
								<div class="profile-dt">
									<ul>
										<li>
											<div class="bagde-dt" title="Partner">
										...
										<li>
											<div class="phone-no" title="Call Us">
												<a href="#"><span><i class="fas fa-phone"></i></span> +2 123 456 7890</a>
											</div>
										</li>
										<li>
											<div class="website" title="Website">
												<a href="#">www.restaurantname.com</a>
											</div>										
										</li>
										<li>
			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-12">
					<div class="left-tab-links">
						<div class="nav nav-pills nav-stacked nav-tabs ui vertical menu fluid" id="myTab">
							...
							<a href="#restaurants-changes" data-toggle="tab" class="item user-tab cursor-pointer">Restaurants Changes</a>
							<a href="#meals" data-toggle="tab" class="item user-tab cursor-pointer">Meals</a>													
							...
							<a href="#request-orders" data-toggle="tab" class="item user-tab cursor-pointer">Request Orders</a>							
				...
				<div class="col-lg-6 col-md-8 col-12">
					<div class="tab-content">
													...
													<form>
														<div class="basic-info v-top">
															...
															<div class="form-group">
																<div class="input-heading">Restaurant Logo*</div>
																<div class="box-1">															
																	<input type="file" id="file">
																	<label for="file">Or Browse...</label>															
																</div>
															</div>
															<div class="form-group">
																<label for="restaurantName">Restaurant Name*</label>
																<input type="text" class="video-form" id="restaurantName" placeholder="Enter Restaurant Name">							
															</div>
															<div class="form-group">
														...
														<div class="basic-info">
															...
															<div class="form-group">
																...
																<input type="tel" class="video-form" id="telNumber" placeholder="Owner / Manager Phone Number">							
															</div>
															<div class="form-group">
																<label for="telNumber1">Restaurant Phone Number*</label>
																<input type="text" class="video-form" id="telNumber1" placeholder="Restaurant Phone Number">							
															</div>
															<div class="form-group">
														...
														<div class="basic-info c-top">
															<h4>Location</h4>
															<div class="form-group">
																<label for="emailAddress1">Enter Address*</label>
																<div class="field-input">
																	<input type="email" class="video-form" id="emailAddress1" placeholder="Enter the address">							
																	<i class="fas fa-search"></i>
																</div>											
															</div>											
															<div class="search-map-location">
																<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6848.588137286094!2d75.8069355495411!3d30.878433570394723!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391a822f25912599%3A0xa51f780d31824240!2sShaheed+Bhagat+Singh+Nagar%2C+Ludhiana%2C+Punjab!5e0!3m2!1sen!2sin!4v1556363627043!5m2!1sen!2sin" height="250" style="border:0" allowfullscreen=""></iframe>
															</div>						
														</div>
														<div class="basic-info c-top">
															...
															<div class="form-group">
																...
																<div class="filter-checkboxs">
																	<ul>
																		...
																		<li>
																		  <input type="checkbox" id="c30" name="cc">
																		  <label for="c30" title="Wednesday"> Dinner</label>
																		</li>
																		<li>
																		  <input type="checkbox" id="c31" name="cc">
																		  <label for="c31" title="Thursday">Cafe's</label>
																		</li>
																		<li>
																		  <input type="checkbox" id="c32" name="cc">
															...
															<div class="form-group">
																...
																<div class="filter-radio">
																	<ul>
																		<li>
																		  <input type="radio" value="value1" id="c5" name="cb4">
																		  <label for="c5">Serve</label>
																		</li>
																		<li>
																		  <input type="radio" value="value2" id="c6" name="cb4">
															...
															<div class="form-group">
																...
																<div class="filter-radio">
																	<ul>
																		<li>
																		  <input type="radio" value="value3" id="c7" name="cb5">
																		  <label for="c7">Available</label>
																		</li>
																		<li>
																		  <input type="radio" value="value4" id="c8" name="cb5">
														...
														<div class="basic-info c-top">
															...
															<div class="form-group">
																...
																<div class="filter-radio">
																	<ul>
																		<li>
																		  <input type="radio" value="value1" id="c9" name="cb6">
																		  <label for="c9">Cash Only</label>
																		</li>
																		<li>
																		  <input type="radio" value="value2" id="c10" name="cb6">
						...
						<div class="tab-pane" id="meals">
							<div class="tab-content-heading">
								<h4>Meals</h4>
								<a href="#" data-toggle="modal" data-target="#addMeal">Add Meal</a>								
								<div class="modal fade" tabindex="-1" id="addMeal" role="dialog"  aria-hidden="true">
								  <div class="modal-dialog modal-lg">
									<div class="modal-content">
									  <div class="modal-body">
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
										<div class="add-meal-new">
											<div class="container">
												<div class="row">
													<div class="col-lg-12 col-md-12 col-12">
														...
														<div class="container">
															<div class="row">
																<div class="col-lg-6 col-md-12 col-12">
																	<div class="form-group">
																		<div class="checkbox-title">Select Meal*</div>
																		<select class="selectpicker" tabindex="-98">
																			<option value="0">Breakfast</option>
																			<option value="1">Lunch</option>
																			<option value="2">Dinner</option>
																			<option value="3">Cafe's</option>
																...
																<div class="col-lg-6 col-md-12 col-12">
																	<div class="form-group">
																		...
																		<input type="text" class="video-form" id="mealName" placeholder="Enter Meal Name">							
																	</div>
																</div>
																<div class="col-lg-6 col-md-12 col-12">
																	<div class="form-group">
																		<label for="mealPrice">Price*</label>
																		<input type="text" class="video-form" id="mealPrice"  placeholder="Enter Price">							
																	</div>
																</div>
																<div class="col-lg-6 col-md-12 col-12">
																	<div class="form-group">
																		<div class="checkbox-title">Select Offers*</div>
																		<select class="selectpicker" tabindex="-98">
																...
																<div class="col-lg-6 col-md-12 col-12">
																	<div class="form-group">
																		<div class="checkbox-title">Extras* <span style="color:#847577; font-size:12px;">(No-veg, select by checkbox)</span></div>
																		<select id="done" class="selectpicker" multiple="" data-done-button="true" tabindex="-98">
																...
																<div class="col-lg-6 col-md-12 col-12">
																	<div class="form-group">
																		<div class="checkbox-title">Select Offers* <span style="color:#847577; font-size:12px;">(veg, select by checkbox)</span></div>
																		<select id="done1" class="selectpicker" multiple="" data-done-button="true" tabindex="-98">
																			<option>Nothing Selected</option>
																			<option>Option 01</option>
																			<option>Option 02</option>
																			<option>Option 03</option>
																...
																<div class="col-lg-12 col-md-12 col-12">
																	<div class="add-meal-image">
																		<input type="file" id="file1">
																		<label for="file1"><i class="far fa-image"></i>  Add Photos</label>									
																	</div>
																</div>
																<div class="col-lg-12 col-md-12 col-12">
																...
																<div class="col-lg-12 col-md-12 col-12">																	
																	<input class="add-meal-btn btn-link" type="submit" value="Add Meal">												
																</div>
															</div>
														</div>														
													</form>
							...
							<div class="restaurants-order-bg m-bottom">
								...
								<div class="order-tabs">
									<ul class="nav nav-tabs">
										<li>
											<a href="#breakfast" data-toggle="tab" class="active">
												<div class="meal-tab-icons">
													<img src="images/homepage/quick-searches/meal-1.svg" class="img-responsive" alt="">
													<p> Breakfast </p>
												</div>
											</a>
										</li>
										<li>
											<a href="#lunch" data-toggle="tab" class="">
												<div class="meal-tab-icons">
													<img src="images/homepage/quick-searches/meal-2.svg" class="img-responsive" alt="">
													<p> Launch </p>
												</div>
											</a>
										</li>
										<li class="">
											<a href="#dinner" data-toggle="tab" class="">
												<div class="meal-tab-icons">
													<img src="images/homepage/quick-searches/meal-3.svg" class="img-responsive" alt="">
													<p> Dinner </p>
												</div>
											</a>
										</li>
										<li>
											<a href="#cafes" data-toggle="tab" class="">
												<div class="meal-tab-icons">
													<img src="images/homepage/quick-searches/meal-4.svg" class="img-responsive" alt="">
													<p> Cafe's </p>
												</div>
											</a>
										</li>
										<li>
											<a href="#delivery" data-toggle="tab" class="">
												<div class="meal-tab-icons">
													<img src="images/homepage/quick-searches/meal-5.svg" class="img-responsive" alt="">
													<p> Delivery </p>
												</div>
											</a>
										</li>
														...
														<div class="meals-dt">
															<div class="meal-list">
																<ul class="list-unstyled">
																	<li>
																		<div class="mel-picy">
																			<img src="images/profile/meal-1.jpg" class="img-responsive" alt="image" title="image">
																		</div>
																		<div class="caption-meal">
																			<a href="meal_detail.html"><h4>Double Tikki Burgur</h4></a>
																			<div class="star">
																				<i class="fas fa-star"></i>
																				<i class="fas fa-star"></i>
																				<i class="fas fa-star"></i>
														...
														<div class="meals-dt">
															<div class="meal-list">
																<ul class="list-unstyled">
																	<li>
																		<div class="mel-picy">
																			<img src="images/profile/meal-2.jpg" class="img-responsive" alt="image" title="image">
																		</div>
																		<div class="caption-meal">
																			<a href="meal_detail.html"><h4>Double Tikki Burgur</h4></a>
																			<div class="star">
														...
														<div class="meals-dt">
															<div class="meal-list">
																<ul class="list-unstyled">
																	<li>
																		<div class="mel-picy">
																			<img src="images/profile/meal-3.jpg" class="img-responsive" alt="image" title="image">
																		</div>
																		<div class="caption-meal">
																			<a href="meal_detail.html"><h4>Double Tikki Burgur</h4></a>
																			<div class="star">
														...
														<div class="meals-dt">
															<div class="meal-list">
																<ul class="list-unstyled">
																	<li>
																		<div class="mel-picy">
																			<img src="images/profile/meal-4.jpg" class="img-responsive" alt="image" title="image">
																		</div>
																		<div class="caption-meal">
																			<a href="meal_detail.html"><h4>Double Tikki Burgur</h4></a>
																			<div class="star">
														...
														<div class="meals-dt">
															<div class="meal-list">
																<ul class="list-unstyled">
																	<li>
																		<div class="mel-picy">
																			<img src="images/profile/meal-5.jpg" class="img-responsive" alt="image" title="image">
																		</div>
																		<div class="caption-meal">
																			<a href="meal-detail.html"><h4>Double Tikki Burgur</h4></a>
																			<div class="star">
																				<i class="fas fa-star"></i>
																				<i class="fas fa-star"></i>
																				<i class="fas fa-star"></i>
														...
														<div class="meals-dt">
															<div class="meal-list">
																<ul class="list-unstyled">
																	<li>
																		<div class="mel-picy">
																			<img src="images/profile/meal-6.jpg" class="img-responsive" alt="image" title="image">
																		</div>
																		<div class="caption-meal">
																			<a href="meal-detail.html"><h4>Double Tikki Burgur</h4></a>
																			<div class="star">
						...
						<div class="tab-pane" id="request-orders">
							<div class="timeline">
								<div class="tab-content-heading">
													...
													<table class="table  table-bordered">
														...
														<tbody>
															<tr>
																...
																<td class="td-content">$22.00</td>
																<td>
																	<button class="accept-btn btn-link" data-toggle="modal" data-target="#trace-2">Accept Order</button>	
																	
																	<div class="modal fade" tabindex="-1" id="trace-2" role="dialog" aria-hidden="true">
																		<div class="modal-dialog modal-xl">
																			<div class="modal-content">
																				<div class="trace-model">
																					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>													
																					<div class="accept-model">
																						<div class="container">
																							<div class="row">
																								<div class="col-lg-4 col-md-12 col-12">
																									<div class="order-user-dt">
																										<div class="order-user-picy">
																											<img src="images/profile/order-img.jpg" alt="">
																										</div>
																										<div class="order-user">	
																											<div class="user-details">
																												<div class="user-picy">
																													<a href="user_profile_view.html"><img src="images/recipe-details/user-dp.png" alt=""></a>
																												</div>
																								...
																								<div class="col-lg-4 col-md-12 col-12">
																									<div class="acpt-order-dt">
																										...
																										<div class="payment-method-dt">
																											<div class="attr-l">Non Vegetarian</div>
																											<div class="attr-r">Non Veg Tikki</div>
																										</div>
																										<div class="payment-method-dt">
																											<div class="attr-l">Vegetarian</div>
																											<div class="attr-r">Double Cheese, Double Tikki</div>
																										</div>
																										<div class="payment-method-dt">
																											<div class="attr-l">Qty</div>
																											<div class="attr-r">2</div>
																										</div>
																										<div class="payment-tol-dt">
																											<div class="attr-l2">Total</div>
																											<div class="attr-r2">$13</div>
																										</div>
																										<button class="accpt-btn btn-link">Accepted</button>
																									</div>
																								</div>
																								<div class="col-lg-4 col-md-12 col-12">
																									<div class="delivery-men">																										
																										<div class="follow-bg">
																											<div class="sd-title">
																												<h3>Near Delivery Men’s</h3>
																											...
																											<ul>
																												<li>
																													<div class="suggestion-usd-2">
																														<a href="user_profile_view.html"><img src="images/profile/noti-5.png" alt=""></a>
																														<div class="sgt-text-2">
																															<a href="user_profile_view.html"><h4>Rockey</h4></a>
																															<p><span><i class="fas fa-map-marker-alt"></i></span> Sydney, Australia</p>
																														</div>
																														<button class="btn-link"><i class="fas fa-phone"></i> Call us</button>
																													</div>
																												</li>
																												<li>
																													<div class="suggestion-usd-2">
